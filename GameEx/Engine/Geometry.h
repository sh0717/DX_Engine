...
public:
	...
	void SetVertices(const vector<T>& vertices) { _vertices.clear(); _vertices = vertices; }
	...
	void SetIndices(const vector<uint32>& indices) { _indices.clear(); _indices = indices; }
